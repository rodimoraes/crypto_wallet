...
class CoinsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create coin" do
    assert_difference('Coin.count') do
      post coins_url, params: { coin: { acronym: @coin.acronym, description: @coin.description, dollar_value: @coin.dollar_value, url_image: @coin.url_image } }
    end
  ...
  test "should update coin" do
    patch coin_url(@coin), params: { coin: { acronym: @coin.acronym, description: @coin.description, dollar_value: @coin.dollar_value, url_image: @coin.url_image } }
